...
/* package haskellator-0.1.0.0 */
#ifndef VERSION_haskellator
#define VERSION_haskellator "0.1.0.0"
#endif /* VERSION_haskellator */
#ifndef MIN_VERSION_haskellator
#define MIN_VERSION_haskellator(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskellator */
...
#define CURRENT_COMPONENT_ID "haskellator-0.1.0.0-inplace-haskellator"
