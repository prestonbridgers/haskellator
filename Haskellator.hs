...
drawUI s = [
           (hCenter $ str $ "Haskellator v0.1") <=> (padTop (Pad 1) $ hCenter $ str $ "when assigning variables assignment must happen on the right side of '=' sign.")
            <=> (padTop (Pad 1) $ hCenter $ str $ "Example: Correct : x = 3+1, y = 4 Wrong: 3+1 = x , 4 = y")
